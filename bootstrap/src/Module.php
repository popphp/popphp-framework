...
class Module extends \Pop\Module\Module
{
    ...
    public function register(Application $application)
    {
        ...
        $this->application->on('app.route.pre', 'Pop\Bootstrap\Event\Console::header', 2)
            ->on('app.dispatch.post', 'Pop\Bootstrap\Event\Console::footer', 1);
    ...
    public function cliError(\Exception $exception)
    {
        ...
        if (stripos(PHP_OS, 'win') === false) {
            ...
            $string .= "    Try \x1b[1;33m./pop help\x1b[0m for help" . PHP_EOL . PHP_EOL;
        } else {
            $string = $message . PHP_EOL . PHP_EOL;
            $string .= '    Try \'./pop help\' for help' . PHP_EOL . PHP_EOL;
        }
